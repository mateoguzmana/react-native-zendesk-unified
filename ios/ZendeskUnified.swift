...
class ZendeskUnified: NSObject {
  ...
  //   AsyncFunction("setAnonymousIdentity") { (
  //     email: String?,
  //     name: String?
  //   ) in
  ...
  //   AsyncFunction("setIdentity") { (
  //     jwt: String
  //   ) in
  //     setIdentity(jwt: jwt)
  //   }

  //   AsyncFunction("openHelpCenter") { (
  //     labels: [String]?,
  //     groupType: String?,
  //     groupIds: [NSNumber]?
  //   ) in
  ...
  //   AsyncFunction("openTicket") { (
  //     ticketId: String
  //   ) in
  //     openTicket(ticketId: ticketId)
  //   }

  //   AsyncFunction("openNewTicket") { (
  //     subject: String?,
  //     tags: [String]?
  //   ) in
  ...
  //   AsyncFunction("listTickets") {
  //     listTickets()
  //   }

  //   AsyncFunction("openArticle") { (
  //     articleId: String
  //   ) in
